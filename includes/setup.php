...
defined('SITE_ROOT') ? null : define ('SITE_ROOT', $_SERVER['DOCUMENT_ROOT'].DS.'cluster');
...
define( 'DB_HOST', '192.168.0.97' );			#set database host
define( 'DB_USER', 'tpi' );				#set database user
define( 'DB_PASS', 'telcomtrix' );				#set database password
define( 'DB_NAME', 'cluster' );					#set database name
...
$dispatch	= new Dispatch($db,$config);
...
$template	= new TlrTemplates(CSS_PATH,JS_PATH);
