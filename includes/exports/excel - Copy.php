...
if(count($rs)>0){
	...
	$all_sheet->setCellValueExplicit('B'.$all_index,'GINA LAGULA',PHPExcel_Cell_DataType::TYPE_STRING);
	$all_sheet->setCellValueExplicit('G'.$all_index,'RONALDO DELA VEGA',PHPExcel_Cell_DataType::TYPE_STRING);
