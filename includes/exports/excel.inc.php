...
$dt = date('Y.m.d');
$filename = "TELCOMTRIXLUZ ".$dt.".xlsx";
...
$objPHPExcel->getProperties()->setCreator("Telcomtrix Philippines Inc.")
							 ...
							 ->setTitle($filename)
							 ->setSubject("Dispatch Summary ".$dt)
...
$objPHPExcel->getActiveSheet()->setCellValue('B1', 'Telcomtrix Phils., Inc.');
...
$objPHPExcel->getActiveSheet()->setCellValue('B2', '241 Pasadena Dr., Santolan Rd.');
$objPHPExcel->getActiveSheet()->setCellValue('B3', 'San Juan City, Manila, Philippines 1500');
