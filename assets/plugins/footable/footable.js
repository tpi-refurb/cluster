...
(function($, F){
	...
	F.Row = F.Class.extend(/** @lends FooTable.Row */{
		...
		define: function(dataOrElement){
			 ...
			 * @type {jQuery}
			 */
			this.$toggle = $('<span/>', {'class': 'footable-toggle fooicon fooicon-plus-circle text-brand'});
		...
		expand: function(){
			...
			self.ft.raise('expand.ft.row').then(function(){
				...
				self.$toggle.removeClass('fooicon-plus-circle').addClass('fooicon-minus-circle');
				self.expanded = true;
			});
		},
		/**
		...
		collapse: function(setExpanded){
			...
			self.ft.raise('collapse.ft.row').then(function(){
				...
				self.$toggle.removeClass('fooicon-minus-circle').addClass('fooicon-plus-circle');
...
(function ($, F) {
	F.Filtering = F.Component.extend(/** @lends FooTable.Filtering */{
		...
		filter: function(query, columns){
			...
			this.$button.children('.fooicon').removeClass('fooicon-search').addClass('fooicon-remove-circle');
			return this._filter();
		},
		/**
		 ...
		 */
		clear: function(){
			this.$button.children('.fooicon').removeClass('fooicon-remove-circle').addClass('fooicon-search');
			this.$input.val(null);
			this.removeFilter('search');
			return this._filter();
		},
		...
		_onSearchButtonClicked: function (e) {
			...
			if ($icon.hasClass('fooicon-remove-circle')) self.clear();
			else self.filter();
		},
		/**
		...
		_onSearchColumnClicked: function (e) {
			...
			self._filterTimeout = setTimeout(function(){
				self._filterTimeout = null;
				var $icon = self.$button.children('.fooicon');
				if ($icon.hasClass('fooicon-remove-circle')){
					$icon.removeClass('fooicon-remove-circle').addClass('fooicon-search');
					self.filter();
				}
			}, self.delay);
		},
