...
// tile
	...
	// Float button state (created on : 2016-07-28)
	(function ($) {
		'use strict';

		$.fn.disableFloatButton = function (state) {
			return this.each(function() {
				var $this = $(this);
				//$this.toggleClass('disabled', state);
				$this.prop('disabled', state);
				if(state==true){					
					$this.removeClass('fbtn-brand-accent');
				}else{
					$this.addClass('fbtn-brand-accent');
				}
			});			
			return this;
		}
		...
		/* USAGE 
		* $('textarea').onEnter(function(){alert('here')})
		*/
